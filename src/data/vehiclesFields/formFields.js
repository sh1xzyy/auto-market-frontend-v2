...
const passengerCar = [
	...
	},
	{
		...
		type: 'checkbox',
		icon: <MdEnergySavingsLeaf color='var(--color-blue-bright)' size={16} />,
	},
	{
		id: 'submit_passenger',
		label: 'Angebote',
...
const other = [
	{
		...
		type: 'iconButton',
		icon: <PiTruck color='var(--color-orange)' size={45} />,
	},
	{
		id: 'other_trailer',
		category: 'iconButton',
		label: 'Anhänger',
		type: 'iconButton',
		icon: <FaTrailer color='var(--color-orange)' size={45} />,
	},
	{
		...
		type: 'iconButton',
		icon: <HiMiniTruck color='var(--color-orange)' size={45} />,
	},
	{
		id: 'other_semiTruck',
		category: 'iconButton',
		label: 'Sattelzüge',
		type: 'iconButton',
		icon: <FaTruckMoving color='var(--color-orange)' size={45} />,
	},
	{
	...
	},
	{
		...
		label: 'Busse',
		type: 'iconButton',
		icon: <FaBus color='var(--color-orange)' size={45} />,
	},
	{
		id: 'other_tractor',
		category: 'iconButton',
		label: 'Agrar',
		type: 'iconButton',
		icon: <FaTractor color='var(--color-orange)' size={45} />,
	},
	{
		...
		label: 'Baumaschinen',
		type: 'iconButton',
		icon: <IoIosConstruct color='var(--color-orange)' size={45} />,
	},
	{
		id: 'other_stacker',
		category: 'iconButton',
		label: 'Stapler',
		type: 'iconButton',
		icon: <MdFrontLoader color='var(--color-orange)' size={45} />,
	},
]
